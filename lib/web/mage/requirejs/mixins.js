...
define('mixins', [
    ...
    var unbundledContext = window.require.s.newContext('$'),
        defaultConfig = window.require.s.contexts._.config,
        unbundledConfig = {
    ...
    /**
     * Extracts url (without baseUrl prefix)
     * from a modules' name ignoring the fact that it may be bundled.
     *
     * @param {String} name - Name, path or alias of a module.
     * @param {Object} config - Contexts' configuartion.
     * @returns {String}
     */
    function getUnbundledPath(name, config) {
    ...
    rjsMixins = {
        ...
        load: function (name, req, onLoad, config) {
            var path     = getUnbundledPath(name, config),
        ...
        processNames: function (names, context) {
            ...
            function processName(name) {
                ...
                var unbundledPath = getUnbundledPath(name, config);

                if (!hasPlugin(name) && (isRelative(name) || rjsMixins.hasMixins(unbundledPath))) {
